//
// Created by Hayden Rivas on 12/6/25.
//
...
namespace mythril::vkstring {


	constexpr StackString<600> VulkanShaderStageFlagBitsToString(const VkShaderStageFlagBits flags) {
		StackString<600> out;
		bool first = true;

		auto add = [&](const VkShaderStageFlags bit, const char* name) constexpr {
			if ((flags & bit) == 0)
				return;
			if (!first)
				out.append("|");
		...
		if (flags == 0) {
			out.assign("VK_SHADER_STAGE_NONE");
			return out;
		}
		add(VK_SHADER_STAGE_VERTEX_BIT,                  "VK_SHADER_STAGE_VERTEX_BIT");
		add(VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT,    "VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT");
		add(VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT, "VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT");
		add(VK_SHADER_STAGE_GEOMETRY_BIT,                "VK_SHADER_STAGE_GEOMETRY_BIT");
		add(VK_SHADER_STAGE_FRAGMENT_BIT,                "VK_SHADER_STAGE_FRAGMENT_BIT");
		add(VK_SHADER_STAGE_COMPUTE_BIT,                 "VK_SHADER_STAGE_COMPUTE_BIT");
		add(VK_SHADER_STAGE_RAYGEN_BIT_KHR,              "VK_SHADER_STAGE_RAYGEN_BIT_KHR");
		add(VK_SHADER_STAGE_ANY_HIT_BIT_KHR,             "VK_SHADER_STAGE_ANY_HIT_BIT_KHR");
		add(VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR,         "VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR");
		add(VK_SHADER_STAGE_MISS_BIT_KHR,                "VK_SHADER_STAGE_MISS_BIT_KHR");
		add(VK_SHADER_STAGE_INTERSECTION_BIT_KHR,        "VK_SHADER_STAGE_INTERSECTION_BIT_KHR");
		add(VK_SHADER_STAGE_CALLABLE_BIT_KHR,             "VK_SHADER_STAGE_CALLABLE_BIT_KHR");
		add(VK_SHADER_STAGE_TASK_BIT_EXT,                 "VK_SHADER_STAGE_TASK_BIT_EXT");
		add(VK_SHADER_STAGE_MESH_BIT_EXT,                 "VK_SHADER_STAGE_MESH_BIT_EXT");
		add(VK_SHADER_STAGE_SUBPASS_SHADING_BIT_HUAWEI,   "VK_SHADER_STAGE_SUBPASS_SHADING_BIT_HUAWEI");
		add(VK_SHADER_STAGE_CLUSTER_CULLING_BIT_HUAWEI,   "VK_SHADER_STAGE_CLUSTER_CULLING_BIT_HUAWEI");
		return out;
	}
	constexpr const char* VulkanDescriptorTypeToString(const VkDescriptorType type) {
		switch (type) {
	...
	constexpr const char* VulkanImageLayoutToString(VkImageLayout layout) {
		switch (layout) {
	...
	constexpr const char* VulkanFormatToString(VkFormat format) {
		switch (format) {
